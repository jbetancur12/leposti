...
const MyMenu = (props, { children }) => {
  ...
  return (
    <Menu className={styles.menu} mode={props.type}>
      ...
      <Menu.Item key="3" className={styles.item}><a href="#questions">Preguntas frecuentes</a></Menu.Item>{isAuthenticated ? (<Menu.Item key="4" className={`${styles.item} ${styles.loginBtn}`}><a href="/dashboard">Dashboard</a></Menu.Item>) :

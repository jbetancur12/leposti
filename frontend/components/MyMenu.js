...
const MyMenu = (props, {children}) => {
    return (
        <Menu className={styles.menu} mode={props.type}>
            <Menu.Item key="4" className={`${styles.item} ${styles.loginBtn} ${styles.loginBtnFirst}`}><a href="#">Iniciar sesión</a></Menu.Item>
            ...
            <Menu.Item key="4" className={`${styles.item} ${styles.loginBtn} ${styles.loginBtnSecond}`}><a href="#">Iniciar sesión</a></Menu.Item>
        </Menu>
    )
}

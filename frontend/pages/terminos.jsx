      ...
      <div className={styles.content}>
        <h2 className={styles.title}>
          <strong>
            <br />
            <br />
            TERMINOS Y CONDICIONES DE USO PLATAFORMA LEPOSTI
          </strong>
        </h2>
        <p>
        ...
        <p>
          ...
          www.leposti.co en adelante la “PLATAFORMA”, lo cual implica que el
          CLIENTE debe seguir las instrucciones que se encuentran en el sitio
        ...
        <p>
          ...
          Al suministrar la información, PRETORI S.A.S realizará el tratamiento
          de la misma, conforme a la POLITICA DE PRIVACIDAD Y PROTECCIÓN DE
          DATOS PERSONALES, la cual puede ser consultada en
          https://www.leposti.com/terminosycondiciones Por lo anterior, el
          CLIENTE y/o USUARIO acepta que la información que suministre a PRETORI
          S.A.S, será utilizada por la Compañía, sus agentes, aliados
          estratégicos, filiales, subsidiarias y proveedores de servicios.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          publicar avisos de publicidad, edictos, emplazamientos, avisos de ley
          y clasificados de manera electrónica y digital. Es quien ha realizado
          de manera exitosa el proceso de Registro y acepta de los Términos y
        ...
        <p>
          ...
          para ordenar por su cuenta y riesgo publicar avisos de publicidad,
        ...
        <p>
          ...
          cuales EL CLIENTE o usuario puede informarse y ordenar publicar avisos
        ...
        <p>
          ...
          y/o Usuarios y los medios de comunicación derivados de la transacción
          que se facilita en la plataforma, a través de la cual se puede
          encontrar información y ordenar la publicación de avisos de
        ...
        <p>
          ...
          artículos, diseños, logotipos, marcas registradas, formularios,
          documentos, gráficos, fotos, imágenes, contenidos en general, su
          organización y compilación, códigos fuente, software y cualquier otra
        ...
        <p>
          ...
          personal del CLIENTE Registrado en la PLATAFORMA. Su cuenta le permite
        ...
        <p>
          ...
          encuentra registrado en las bases de datos de la PLATAFORMA. Con este
        ...
        <p>
          ...
          correo electrónico desde la dirección servicioalcliente@leposti.com.
          PRETORI S.A.S será responsable únicamente por las comunicaciones y/o
          notificaciones enviadas desde este medio y no será responsable frente
        ...
        <p>
          ...
          vía electrónica. Las dudas que surjan respecto de la eficacia y
        ...
        <p>
          ...
          idiomas escritos. Para efectos de las publicaciones que realizarán los
        ...
        <p>
          ...
          actividades comerciales y comunicar estrategias o campañas
          publicitarias o de mercadeo, propias o de terceros ; realizada como
          mecanismo de referencia y no como oferta pública.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          servicios para la publicación de avisos de publicidad, edictos, avisos
          de ley y clasificados, de los principales medios de comunicación y
          puedan realizar la transacción de compraventa de estos productos en
          línea, a través de la misma PLATAFORMA de manera electrónica.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          principales medios de comunicación, ii) facilita la transacción de la
          publicación para la realización del vínculo contractual entre el medio
          de comunicación y el Usuario o Cliente, iii) permite el uso de la
          plataforma de pagos iv) sirve de medio de envío de comunicaciones
          entre los CLIENTES y/o Usuarios o y los medios de comunicación.
        </p>
        <p>
          <strong>3.2. CONDICIONES PARTICULARES DEL SERVICIO</strong>
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          de sus clientes y demás personas cuyos datos personales ingrese a la
          PLATAFORMA, la autorización expresa, voluntaria e irrevocable para el
          manejo de información de contenido personal.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          1999, el CLIENTE y/o Usuario al momento de la creación de la Cuenta de
        ...
        <p>
          ...
          adquieren carácter y entidad probatoria. En consecuencia, entiende el
          CLIENTE, que mediante el cruce de mensajes de datos las partes pueden
          dar lugar al nacimiento, modificación y extinción de obligaciones,
          siendo de su resorte exclusivo el contenido, consecuencias,
        ...
        <p>
          ...
          u otra actuación con su firma electrónica o digital; cada documento
          que genere, operación que realice, firme, valide, ordene o autorice,
          será vinculante, cuya firma electrónica o digital, sustituye o
          reemplaza para todos los efectos su firma física y; reconoce que tales
        ...
        <p>
          ...
          PRETORI S.A.S, sobre cualquier situación que ponga en duda la
        ...
        <p>
          ...
          y 67, numeral 1 de la Ley 1437 de 2011, los artículos 20 y 21 de la
          Ley 527 de 1999, las cuales serán enviadas al correo electrónico
          indicado a PRETORI S.A.S. Para el efecto, declara que conoce y acepta
          los términos, condiciones e instrucciones, sobre la notificación por
          medios electrónicos que profiera PRETORI S.A.S.{' '}
        </p>
        <p>
          <strong>
            4.2. AUTENTICIDAD DE LAS OPERACIONES Y TRANSACCIONES REALIZADAS EN
            LA PLATAFORMA.{' '}
          </strong>
        </p>
        <p>
          ...
          PRETORI S.A.S. Se conviene igualmente que la firma electrónica o
        ...
        <p>
          <strong>
            4.3. DESMATERIALIZACIÓN DE LAS OPERACIONES Y TRANSACCIONES
        ...
        <p>
          ...
          registradas en la PLATAFORMA mediante los medios tecnológicos idóneos
          para garantizar su inalterabilidad, rastreabilidad y recuperabilidad.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          CLIENTE comprende que el uso de este Sitio está sujeto al propio
          riesgo del CLIENTE. Producto de lo anterior, si el uso del Sitio
          deriva en que el CLIENTE deba incurrir en reparaciones y/o
          correcciones, contratando algún servicio de mantenimiento de sus
          equipos computacionales, estos costos deberán ser asumidos por el
          CLIENTE, sin tener PRETORI S.A.S responsabilidad alguna en esta
          materia, que el CLIENTE no pueda hacer Uso del Sitio por no utilizar
          equipos con herramientas tecnológicas aptas (software, hardware,
          navegadores) para el ingreso a la PLATAFORMA. PRETORI S.A.S se excluye
          de cualquier responsabilidad por los daños y perjuicios de cualquier
          naturaleza que puedan derivarse de la presencia de virus u otros
        ...
        <p>
          ...
          debido a dificultades técnicas, fallas de internet o razones ajenas a
          PRETORI S.A.S, por lo que el CLIENTE comprende que PRETORI S.A.S no
          garantiza el acceso continuo e ininterrumpido del Sitio y/o de
          secciones del mismo. En caso de interrupción del servicio, PRETORI
          S.A.S hará su mejor esfuerzo por restablecer el Sitio y sus servicios
          con prontitud, sin que de ello pudiera derivarse ningún tipo de
          obligación ni responsabilidad para PRETORI S.A.S o que se deba
          establecer un tiempo límite para ello. PRETORI S.A.S se excluye de
        ...
        <p>
          ...
          registrada y guardada en la PLATAFORMA. Sin embargo, el CLIENTE
          comprende y acepta que PRETORI S.A.S tiene el derecho de monitorear el
          Sitio de manera electrónica, de tiempo en tiempo y hacer seguimiento a
          cualquier información y/o conductas sospechosas de CLIENTE , según el
          propio criterio de PRETORI S.A.S y al servicio y satisfacción de la
          ley, regulaciones y/o requerimientos de autoridad competente, para
          asegurar la correcta operación del Sitio y para protegerse a sí mismo
        ...
        <p>
          ...
          embargo, PRETORI S.A.S se reserva el derecho de verificar las cuentas
          de manera aleatoria, verificando la veracidad de la información. En
          caso de detectar fraude, PRETORI S.A.S podrá cancelar la Cuenta y
          entregar los antecedentes a la justicia de conformidad con lo señalado
          en los lineamientos legales en la legislación Colombiana,
        ...
        <p>
          ...
          generado al CLIENTE a partir del uso del Sitio y de sus Contenidos.
          Los colaboradores, directores y representantes de PRETORI S.A.S, no
          serán responsables de los daños generados por errores, omisiones,
          interrupciones, defectos, retrasos en la información, transmisión,
        ...
        <p>
          ...
          S.A.S, ni la garantía por parte de PRETORI S.A.S de los productos, la
          información y los servicios ofrecidos por el sitio vinculado, ni será
          responsable PRETORI S.A.S S.A de cualquier transacción que sea
          realizada por medio de los vínculos de ésta página. Cualquier
          transacción que el CLIENTE y/o Usuario lleve a cabo con los
          anunciantes de PRETORI S.A.S, se realiza única y exclusivamente entre
          el CLIENTE y el anunciante o sitio vinculado, bajo su propia
          responsabilidad. Los sitios vinculados a PRETORI S.A.S, no están
          controlados por PRETORI S.A.S S.A, razón por la cual, este no es
          responsable del contenido, información, cumplimiento y exactitud de
        ...
        <p>
          ...
          virtud de perjuicios derivados de los casos señalados.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          la Política de Privacidad de la información de PRETORI S.A.S.
        </p>
        <p>
          <strong>6.1. INFORMACIÓN DEL CLIENTE</strong>
        </p>
        <p>
        ...
        <p>
          ...
          pero sin limitarse, razón social, nombres, apellidos, tipo de
        ...
        <p>
          ...
          amenazante, pornográfica, o cualquier información que abiertamente
          atente contra la moral, las buenas costumbres o el orden público o que
        ...
        <p>
          ...
          través de sección contacto del sitio o a través del correo electrónico
          servicioalcliente@leposti.com, u otros correos electrónicos definidos
          por PRETORI S.A.S.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          información personal en su perfil cuantas veces lo desee.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          el CLIENTE comparte su Nombre de CLIENTE y Contraseña con terceros, el
          mismo comprende que esta acción es realizada bajo su propio riesgo y
          responsabilidad. PRETORI S.A.S proveerá mecanismos para que el CLIENTE
          recupere su Contraseña en el caso que la haya olvidado. PRETORI S.A.S
        ...
        <p>
          ...
          PRETORI S.A.S recomienda al CLIENTE proteger su nombre de CLIENTE y
          Contraseña, manteniéndolas siempre en privado y no compartiendo dicha
          información, la cual siempre debe ser manejada en forma personal y
          privada. El nombre de Usuario y Contraseña, requeridos para
        ...
        <p>
          ...
          el Contrato de Uso del Sitio, incluyendo pero sin limitarse, los
          Términos y Condiciones y Políticas de Privacidad. Por tanto, PRETORI
          S.A.S recomienda al CLIENTE revisar las Políticas de Privacidad y/o
          seguridad de este tipo de sitios antes de entregar cualquier
          información personal requerida por los mismos. PRETORI S.A.S no se
          hace responsable por la información entregada por el CLIENTE en dichos
          sitios ni del uso que éstos hagan con tal información.{' '}
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          individualización al momento en que cree su propio Perfil dentro de
          LEPOSTI.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          edictos, emplazamientos, avisos de ley y clasificados de manera
          electrónica y digital, la PLATAFORMA contendrá la información
          necesaria y suficiente para que el CLIENTE pueda efectuar dichas
          publicaciones y el respectivo pago, contando con la mayor información
          posible.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          mecanismos, PRETORI S.A.S utiliza tecnología de encriptación de datos
          u otras tecnologías para proteger la información del CLIENTE
        ...
        <p>
          ...
          sea objeto de hackeos o ciberataques y; por ello, tampoco la
          información referente al ingreso del Sitio, la admisión y acceso como
        ...
        <p>
          ...
          objetivo de proveer un adecuado servicio al CLIENTE Registrado, con el
        ...
        <p>
          ...
          PLATAFORMA. PRETORI S.A.S se reserva el derecho a no enviar todas las
          comunicaciones y/o notificaciones al CLIENTE por e-mail. PRETORI S.A.S
          podrá comunicar cierta información únicamente a través de mensajería
          interna del Sitio, de acuerdo a su propio criterio.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          Analytics para el dominio del CLIENTE envían datos únicamente a los
          servidores del dominio del CLIENTE. De este modo las cookies de Google
          Analytics se convierten en propiedad personal del dominio del CLIENTE
        ...
        <p>
          ...
          medios que PRETORI S.A.S haya definido con el CLIENTE (email, correo,
          en las oficinas de PRETORI S.A.S, entre otros), debe ser veraz,
        ...
        <p>
          ...
          CLIENTE el único responsable por los daños y perjuicios generados por
          cualquier inexactitud en la información que pudiera recaer sobre sí
          mismo, sobre PRETORI S.A.S y/o sobre terceros. PRETORI S.A.S no se
          hace responsable por las faltas en que incurra el CLIENTE respecto de
          ésta cláusula frente a terceros.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          proporcionó, PRETORI S.A.S podrá desactivar la Cuenta y Registro del
          CLIENTE, pudiendo poner término al presente Contrato de Uso del Sitio,
          al servicio asociado del mismo, y negar el acceso al CLIENTE de la
          manera expresada en el Numeral 10.2. Lo anterior, es sin perjuicio del
          derecho de PRETORI S.A.S de iniciar las acciones legales que estime
          convenientes contra el CLIENTE que haya proporcionado información
          falsa.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          anteriores y/o para poner estas listas de distribución a disposición
          de terceros.{' '}
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          de los productos, la información y los servicios ofrecidos por el
          sitio vinculado, ni será responsable PRETORI S.A.S S.A de cualquier
        ...
        <p>
          ...
          bajo su propia responsabilidad. Los sitios vinculados a PRETORI S.A.S,
          no están controlados por PRETORI S.A.S S.A, razón por la cual, este no
          es responsable del contenido, información, cumplimiento y exactitud de
          ninguno de estos sitios, ni es responsable por ningún tipo de
          transmisión recibida desde cualquier sitio vinculado.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          todas sus Marcas, nombres comerciales, patentes, modelos de utilidad,
        ...
        <p>
          ...
          reserva el derecho de explotar sus derechos de Propiedad Industrial
        ...
        <p>
          ...
          pueda proceder al uso de la PLATAFORMA.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          propiedad de PRETORI S.A.S. El CLIENTE reconoce, declara y acepta que
          el Uso del Sitio y los servicios prestados por PRETORI S.A.S a través
          de la PLATAFORMA no le otorgan derecho alguno sobre los Signos
          Distintivos ni Sobre los Contenidos.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          limitativo, medios electrónicos, mecánicos, grabaciones, fotocopias,
          entre otros, sin la previa autorización escrita por parte de PRETORI
        ...
        <p>
          ...
          CLIENTE de los servicios que le provee PRETORI S.A.S a través del
          Sitio. El CLIENTE no podrá modificar o realizar creaciones a partir de
          parte de los Contenidos o de la totalidad de éstos, que se encuentren
          publicados en el Sitio. Se prohíbe el uso del Contenido de la
          PLATAFORMA LEPOSTI en cualquier otro sitio, incluyendo links de
          PRETORI S.A.S en otros sitios web, con o sin el logo de PRETORI S.A.S,
          sin la previa autorización escrita por parte de PRETORI S.A.S. El
          CLIENTE no podrá reproducir un sitio “espejo” del sitio web de PRETORI
          S.A.S o de parte de este, mantenerlo en otros servidores ni publicarlo
          en internet.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          intelectual, y dará derecho a PRETORI S.A.S para desactivar la Cuenta
          y Registro del CLIENTE, pudiendo poner término al presente Contrato de
          Uso del Sitio, al servicio asociado al mismo y negar el acceso al
          CLIENTE o de la manera expresada el Numeral 10.4 de este documento. Lo
          anterior, es sin perjuicio del derecho de PRETORI S.A.S de ejercer
          todas las acciones, tanto civiles como penales, destinadas al
          resguardo de sus legítimos derechos de propiedad intelectual.
          Cualquier pregunta relativa a las marcas registradas y/o al uso del
          Contenido de PRETORI S.A.S deberá ser realizada directamente a PRETORI
          S.A.S.{' '}
        </p>
        <p>
          <strong>
            10. MODIFICACIONES Y PLAZO DEL CONTRATO DE USO DEL SITIO.{' '}
          </strong>
        </p>
        <p>
        ...
        <p>
          ...
          introducidas, PRETORI S.A.S comunicará oportunamente al CLIENTE de las
          modificaciones que se hayan realizado en el Contrato de Uso del Sitio
          a través de la publicación de una notificación dirigida al CLIENTE
          cuando este intente acceder al Sitio. El Contrato de Uso del Sitio,
        ...
        <p>
          ...
          documento de validación, de conformidad con lo expresado en este
          documento.{' '}
        </p>
        <p>
        ...
        <p>
          <strong>
            <u>
              Se deja expresa constancia que el CLIENTE no podrá retractarse de
              los presentes Términos y Condiciones y sus anexos.{' '}
            </u>
          </strong>
        </p>
        <p>
        ...
        <p>
          ...
          Términos y Condiciones del presente Contrato, así como también sujeto
        ...
        <p>
          ...
          discriminatorio, violento, amenazante, de acoso, difamatorio,
          denigratorio, inmoral, obsceno o pornográfico y que pudiere por dicha
        ...
        <p>
          ...
          de la PLATAFORMA , incluyendo a modo de ejemplo y no limitativo la
          publicación de nombres, direcciones, números de teléfono, direcciones
          de correo electrónico, direcciones particulares o laborales,
          identificaciones, información de cuentas corrientes y/o de tarjetas de
          crédito, entre otras, independiente de que esa información privada o
          de identificación personal de un tercero que se encuentre publicada
        ...
        <p>
          ...
          derechos fundamentales y las libertades reconocidas
          constitucionalmente; las acciones que induzcan o promuevan acciones
        ...
        <p>
          ...
          CLIENTE, pudiendo poner término al presente Contrato de Uso del Sitio,
          al servicio asociado al mismo y negar el acceso al CLIENTE de la
          manera expresada en el Numeral 10.4. Lo anterior, es sin perjuicio del
          derecho de PRETORI S.A.S de ejercer todas las acciones, tanto civiles
          como penales, destinadas al resguardo de sus legítimos derechos y las
          de sus miembros y el CLIENTE.{' '}
        </p>
        <p>
          <strong>
            10.5. FACULTADES DE PRETORI S.A.S EN RELACION CON LOS CONTENIDOS DEL
            SITIO.{' '}
          </strong>
        </p>
        <p>
          ...
          encabezamiento, sin necesidad de ninguna notificación previa al
          CLIENTE. Así mismo, se deja constancia de que el Sitio podría contener
          errores técnicos y/o tipográficos, por lo que PRETORI S.A.S no será
          responsable de ningún perjuicio derivado de dichos errores
          involuntarios.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          Específicas adicionales a las contenidas en el presente Contrato de
        ...
        <p>
          ...
          el acceso a las secciones específicas relevantes del Sitio y de las
          páginas web que lo conforman. A este respecto, se deja expresa
          constancia de que PRETORI S.A.S podrá cambiar y/o restringir el acceso
          a todo o a una porción del Sitio sin previa notificación al CLIENTE y
          sin responsabilidad alguna para PRETORI S.A.S en caso que el CLIENTE
          estime que se le haya generado un daño a partir de esa acción.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          Contrato de Uso del Sitio y los derechos y obligaciones que de ellas
          emanan, mantendrán su plena vigencia y validez.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          de Uso del Sitio en todas sus partes, aceptando regirse por todos sus
        ...
        <p>
          ...
          acceder, navegar y usar el Sitio inmediatamente. Así mismo, no podrá
        ...
        <p>
          ...
          que el CLIENTE necesite identificar y corregir errores en el envío o
          en sus datos, podrá contactar a PRETORI S.A.S en el correo electrónico
          servicioalcliente@leposti.com.{' '}
        </p>
      </div>
      <MyFooter />
